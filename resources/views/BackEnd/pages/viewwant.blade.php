                                            ...
                                            <table id="table_info" class="table table-bordered table-striped table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($want as $data)
                                                        ...
                                                        <td> {{ $data->email }} </td>
                                                        <td>
                                                            <a href=" {{ url('/want-help-info/'.$data->id) }} " class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="right" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach                                            
                                                </tbody>
